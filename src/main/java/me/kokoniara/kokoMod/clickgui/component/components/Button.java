package me.kokoniara.kokoMod.clickgui.component.components;
...
import me.kokoniara.kokoMod.clickgui.component.components.sub.Checkbox;
import me.kokoniara.kokoMod.clickgui.component.components.sub.Keybind;
import me.kokoniara.kokoMod.clickgui.component.components.sub.ModeButton;
import me.kokoniara.kokoMod.clickgui.component.components.sub.Slider;
import me.kokoniara.kokoMod.clickgui.component.components.sub.VisibleButton;
...
public class Button extends Component {
	...
	public Button(Module mod, Frame parent, int offset) {
		...
		height = 12;
		int opY = offset + 12;
		if(kokoMod.instance.settingsManager.getSettingsByMod(mod) != null) {
			for(Setting s : kokoMod.instance.settingsManager.getSettingsByMod(mod)){
				if(s.isCombo()){
